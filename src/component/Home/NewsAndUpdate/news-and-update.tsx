        ...
        {news_and_update.map((chi, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-2 lg:p-8 p-5 h-full transition-all duration-300 bg-white group-hover/bg:bg-blue-100  relative overflow-hidden">
                ...
                <p className="text-xs relative z-10 mt-auto py-3">{date}</p>
              </div>
            </div>
          );
        })}
