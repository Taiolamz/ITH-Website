...
const WhoAreWe = () => {
  ...
  return (
    <Section className="lg:flex mt-10 lg:overflow-x-auto overflow-x-hidden overflow-y-hidden  lg:mt-40 lg:flex-col w-full lg:justify-center">
      <div className="grid lg:grid-cols-[1.7fr_1fr] rows-2 gap-4   w-full items-center relative ">
        <div className="w-full relative">
          <div className="bg-[#002887] lg:w-full rounded-[5px]  lg:-mb-16 lg:ml-16 lg:h-[300px] w-full h-[40px]  absolute lg:bottom-0 -bottom-4"></div>
